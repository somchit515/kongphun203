...
$i=1;
include('../../condb.php');
$sql = mysqli_query($con,"SELECT a.*,b.*,c.*,d.* from positionlevel as a,duties as b,sungkud as c,historys_personsall as d where a.pl_id=d.pl_id and b.dts_id=d.dts_id and c.sk_id=d.sk_id");
