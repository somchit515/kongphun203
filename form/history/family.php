...
$i=1;
include('../../condb.php');
$sql = mysqli_query($con,"SELECT a.*,b.*,c.*,d.* from positionlevel as a,duties as b,sungkud as c,historys_personsall as d where a.pl_id=d.pl_id and b.dts_id=d.dts_id and c.sk_id=d.sk_id and d.status_mw='ຄອບຄົວ'");
...
<td><a class="btn btn-warning btn-sm" href="download_document.php?download=<?php echo $row ['file_db']?>" onclick="return confirm('ທ່ານຕ້ອງການດາວໂຫລດເອກະສານແມ່ນບໍ່?')"><span><i class="fas fa-download text-danger"></i> </span></a> </td>
