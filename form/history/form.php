...
<input type="text" class="form-control" name="hp_id" id="hp_id" value="" placeholder="ກະລຸນນາປ້ອນເລກບັດປະຈຳໂຕ">
</div>
</div> 
...
<input type="text" class="form-control" name="flname_hp" id="flname_hp" value="" placeholder="ກະລຸນນາປ້ອນຊື່ ແລະ ນາມສະກຸນ">
</div>
</div> 
...
<option value="ກະລຸນນາເລືອກສັງກັດ">ເລືອກສັງກັດ</option>
<?php 
include('condb.php');
...
<input type="date" class="form-control" name="hbd_hp" id="hbd_hp" value="" placeholder="">
</div>
</div> 
<div class="form-group">
<label for="">ວດປ ເຂົ້າທະຫານ:</label>
<div class="input-group ">
<div class="input-group-append">
<div class="input-group-text">
<span class="text-danger"><i class="ion-android-calendar"></i></span>
...
<input type="date" class="form-control" name="datel_hp" id="datel_hp" value="" placeholder="">
</div>
</div> 
...
<input type="date" class="form-control" name="dateh_hp" id="dateh_hp" value="" placeholder="">
</div>
</div> 
...
<input type="date" class="form-control" name="dateb_hp" id="dateb_hp" value="" placeholder="">
</div>
</div> 
<div class="form-group">
...
<input type="date" class="form-control" name="datek_hp" id="datek_hp" value="" placeholder="">
...
<input type="date" class="form-control" name="daten_hp" id="daten_hp" value="" placeholder="">
</div>
</div>
...
<input type="date" class="form-control" name="datew_hp" id="datew_hp" value="" placeholder="">
</div>
</div> 
</div>
<div class="col-sm-3">
...
<input name="vg_id" class="form-control" id="villages" required></input>
...
<input name="dt_id" class="form-control" id="districts" required></input>
...
<input type="text" name="villn_hp" id="villn_hp" class="form-control" placeholder="" aria-describedby="helpId">
...
<input type="text" name="disn_hp" id="disn_hp" class="form-control" placeholder="" aria-describedby="helpId">
...
<input type="text" name="remark_hp" id="remark_hp" class="form-control" placeholder="" aria-describedby="helpId">
...
<input type="file" name="img_photo" id="img_photo" class="form-control" placeholder="" >
