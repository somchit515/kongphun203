...
<input type="text" name="fname" id="fname" value="" class="form-control"  placeholder="ກະລຸນນາປ້ອນຊື່">
</div>
</div> 
<div class="form-group">
...
<input type="text" name="lname" id="lname" value="" class="form-control"  placeholder="ກະລຸນນາປ້ອນນາມສະກຸນ">
</div>
</div> 
<div class="form-group">
<label for="">ເພດ:</label>
...
<input type="text" name="user_name" id="user_name" value="" class="form-control"  placeholder="ກະລຸນນາປ້ອນຊື່ຜຸ້ໃຊ້ງານ">
</div>
</div> 
...
<input type="text" name="user_pass" id="user_pass" value="" class="form-control"  placeholder="ກະລຸນນາປ້ອນລະຫັດຜ່ານ">
</div>
</div> 
<div class="form-group">
...
<input type="text" name="tel" id="tel" value="" class="form-control"  placeholder="ກະລຸນນາປ້ອນເບີໂທ">
</div>
</div> 
...
<input type="file" name="ps_img" id="ps_img" value="" class="form-control"  placeholder="ກະລຸນນາປ້ອນຮູບພາບ">
</div>
</div> 
</div>
</div>
